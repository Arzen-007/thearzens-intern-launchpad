...
export default function DashboardLayout({
        ...
        <div className="w-full max-w-md border border-cyan-300/25 bg-[#071018] p-8 shadow-[0_0_60px_rgba(76,233,255,.08)]">
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            <p className="max-w-sm text-sm leading-6 text-cyan-100/60">
              The catalog control room is protected. Authenticate to verify owner access before viewing or changing GitHub-managed resources.
            </p>
          </div>
          <Button
            onClick={() => startLogin()}
            size="lg"
            className="mt-7 w-full bg-cyan-300 font-mono text-xs uppercase tracking-[.12em] text-slate-950 hover:bg-cyan-200"
          >
  ...
  return (
    ...
    >
      <DashboardLayoutContent navigationItems={navigationItems} setSidebarWidth={setSidebarWidth} title={title}>
        {children}
